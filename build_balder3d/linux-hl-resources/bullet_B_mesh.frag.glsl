...
void main()
{
    ...
    vec3 basecol = vec3(0.0, 0.02699177153408527374267578125, 0.80000007152557373046875);
    float roughness = 0.0;
    float metallic = 0.0;
    float occlusion = 1.0;
    float specular = 0.5;
    vec3 emissionCol = vec3(0.0, 0.04982936382293701171875, 8.393184661865234375);
