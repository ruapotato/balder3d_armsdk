...
#ifndef INC_arm__node__Bullet_A
#define INC_arm__node__Bullet_A
typedef struct _arm__node__$Bullet_A *arm__node__$Bullet_A;
typedef struct _arm__node__Bullet_A *arm__node__Bullet_A;
#include <hl/Class.h>
