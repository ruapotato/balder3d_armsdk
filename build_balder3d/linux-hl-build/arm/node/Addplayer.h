...
#ifndef INC_arm__node__Addplayer
#define INC_arm__node__Addplayer
typedef struct _arm__node__$Addplayer *arm__node__$Addplayer;
typedef struct _arm__node__Addplayer *arm__node__Addplayer;
#include <hl/Class.h>
