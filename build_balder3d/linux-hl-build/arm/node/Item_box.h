...
#ifndef INC_arm__node__Item_box
#define INC_arm__node__Item_box
typedef struct _arm__node__$Item_box *arm__node__$Item_box;
typedef struct _arm__node__Item_box *arm__node__Item_box;
#include <hl/Class.h>
