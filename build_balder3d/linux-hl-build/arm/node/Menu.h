...
#ifndef INC_arm__node__Menu
#define INC_arm__node__Menu
typedef struct _arm__node__$Menu *arm__node__$Menu;
typedef struct _arm__node__Menu *arm__node__Menu;
#include <hl/Class.h>
