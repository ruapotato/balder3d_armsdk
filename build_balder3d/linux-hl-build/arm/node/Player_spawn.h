...
#ifndef INC_arm__node__Player_spawn
#define INC_arm__node__Player_spawn
typedef struct _arm__node__$Player_spawn *arm__node__$Player_spawn;
typedef struct _arm__node__Player_spawn *arm__node__Player_spawn;
#include <hl/Class.h>
...
struct _arm__node__$Player_spawn {
	hl_type *$type;
	hl_type* __type__;
	vdynamic* __meta__;
...
struct _arm__node__Player_spawn {
	hl_type *$type;
