...
bool StringTools_isSpace(String r0,int r1) {
	...
	r3 = r2 ? r2->v.i : 0;
	r4 = 8;
	if( r4 >= r3 ) goto label$de37252_3_8;
	r3 = r2 ? r2->v.i : 0;
	r4 = 14;
	if( r3 < r4 ) goto label$de37252_3_15;
	label$de37252_3_8:
	r3 = 32;
	r6 = hl_alloc_dynamic(&t$_i32);
	r6->v.i = r3;
	if( r2 == r6 || (r2 && r6 && (r2->v.i == r6->v.i)) ) goto label$de37252_3_13;
	r5 = false;
	goto label$de37252_3_14;
	label$de37252_3_13:
	r5 = true;
	label$de37252_3_14:
	return r5;
...
String StringTools_ltrim(String r0) {
	...
	r3 = 0;
	label$de37252_4_3:
	if( r3 >= r1 ) goto label$de37252_4_9;
	r5 = StringTools_isSpace(r0,r3);
	if( !r5 ) goto label$de37252_4_9;
	++r3;
	goto label$de37252_4_3;
	label$de37252_4_9:
	r4 = 0;
	if( r4 >= r3 ) goto label$de37252_4_16;
	if( r0 == NULL ) hl_null_access();
	r4 = r1 - r3;
	r6 = hl_alloc_dynamic(&t$_i32);
	r6->v.i = r4;
...
String StringTools_rtrim(String r0) {
	...
	r3 = 0;
	label$de37252_5_3:
	if( r3 >= r1 ) goto label$de37252_5_12;
	r4 = r1 - r3;
	r5 = 1;
	r4 = r4 - r5;
	r6 = StringTools_isSpace(r0,r4);
	if( !r6 ) goto label$de37252_5_12;
	++r3;
	goto label$de37252_5_3;
	label$de37252_5_12:
	r5 = 0;
	if( r5 >= r3 ) goto label$de37252_5_20;
	if( r0 == NULL ) hl_null_access();
	r4 = 0;
	r5 = r1 - r3;
