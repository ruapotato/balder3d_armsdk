...
void armory_logicnode_IsFalseNode_new(armory__logicnode__IsFalseNode r0,armory__logicnode__LogicTree r1) {
	armory_logicnode_LogicNode_new(((armory__logicnode__LogicNode)r0),r1);
	return;
}

void armory_logicnode_IsFalseNode_run(armory__logicnode__IsFalseNode r0,int r1) {
	...
	r3 = 1;
	r4 = r2->length;
	if( ((unsigned)r3) < ((unsigned)r4) ) goto label$4025b74_2_7;
	r5 = NULL;
	goto label$4025b74_2_10;
	label$4025b74_2_7:
	r7 = r2->array;
	r6 = ((vdynamic**)(r7 + 1))[r3];
	...
	if( r10 ) goto label$4025b74_2_19;
	r3 = 0;
