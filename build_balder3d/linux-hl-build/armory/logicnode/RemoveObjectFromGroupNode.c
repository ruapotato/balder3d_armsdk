...
void armory_logicnode_RemoveObjectFromGroupNode_new(armory__logicnode__RemoveObjectFromGroupNode r0,armory__logicnode__LogicTree r1) {
	armory_logicnode_LogicNode_new(((armory__logicnode__LogicNode)r0),r1);
	return;
}

void armory_logicnode_RemoveObjectFromGroupNode_run(armory__logicnode__RemoveObjectFromGroupNode r0,int r1) {
	String r11;
	...
	r3 = 1;
	r4 = r2->length;
	if( ((unsigned)r3) < ((unsigned)r4) ) goto label$264dfd3_2_7;
	r5 = NULL;
	goto label$264dfd3_2_10;
	label$264dfd3_2_7:
	r7 = r2->array;
	r6 = ((vdynamic**)(r7 + 1))[r3];
	...
	r3 = 2;
	r4 = r2->length;
	if( ((unsigned)r3) < ((unsigned)r4) ) goto label$264dfd3_2_23;
	r10 = NULL;
	goto label$264dfd3_2_26;
	label$264dfd3_2_23:
	r7 = r2->array;
	r6 = ((vdynamic**)(r7 + 1))[r3];
	...
	r2 = iron_Scene_getGroup(r14,r11);
	if( r2 == NULL ) hl_null_access();
	r13 = hl_types_ArrayObj_remove(r2,((vdynamic*)r12));
	r3 = 0;
