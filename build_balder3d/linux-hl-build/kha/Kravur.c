...
kha__KravurImage kha_Kravur__get(kha__Kravur r0,int r1) {
	...
	r2 = r3->fontGlyphs;
	r6 = r0->oldGlyphs;
	if( r2 == r6 ) goto label$6c4203c_1_112;
	r0->oldGlyphs = r2;
	r8 = 4;
	...
	r9 = 0;
	r10 = r2->length;
	if( ((unsigned)r9) < ((unsigned)r10) ) goto label$6c4203c_1_14;
	r9 = 0;
	goto label$6c4203c_1_18;
	label$6c4203c_1_14:
	r11 = r2->bytes;
	r10 = 2;
	r10 = r9 << r10;
	...
	*(int*)(r7 + r10) = r9;
	...
	r8 = 0;
	r9 = r5->length;
	if( ((unsigned)r8) < ((unsigned)r9) ) goto label$6c4203c_1_34;
	r8 = 0;
	goto label$6c4203c_1_38;
	label$6c4203c_1_34:
	r7 = r5->bytes;
	r9 = 2;
	r9 = r8 << r9;
	...
	r10 = r2->length;
	label$6c4203c_1_42:
	if( r9 >= r10 ) goto label$6c4203c_1_96;
	r13 = r9;
	++r9;
	if( r2 == NULL ) hl_null_access();
	r15 = r2->length;
	if( ((unsigned)r13) < ((unsigned)r15) ) goto label$6c4203c_1_51;
	r14 = 0;
	goto label$6c4203c_1_55;
	label$6c4203c_1_51:
	r7 = r2->bytes;
	r15 = 2;
	r15 = r13 << r15;
	r14 = *(int*)(r7 + r15);
	label$6c4203c_1_55:
	if( r14 == r8 ) goto label$6c4203c_1_94;
	r12 = (kha__$KravurImage)g$_kha_KravurImage;
	r5 = r12->charBlocks;
	if( r5 == NULL ) hl_null_access();
	r15 = 1;
	r14 = r13 - r15;
	r15 = r2->length;
	if( ((unsigned)r14) < ((unsigned)r15) ) goto label$6c4203c_1_65;
	r14 = 0;
	goto label$6c4203c_1_69;
	label$6c4203c_1_65:
	r7 = r2->bytes;
	r15 = 2;
	r15 = r14 << r15;
	...
	if( r5 == NULL ) hl_null_access();
	r15 = r2->length;
	if( ((unsigned)r13) < ((unsigned)r15) ) goto label$6c4203c_1_77;
	r14 = 0;
	goto label$6c4203c_1_81;
	label$6c4203c_1_77:
	r7 = r2->bytes;
	r15 = 2;
	r15 = r13 << r15;
	...
	r14 = hl_types_ArrayBytes_Int_push(r5,r14);
	r15 = r2->length;
	if( ((unsigned)r13) < ((unsigned)r15) ) goto label$6c4203c_1_86;
	r14 = 0;
	goto label$6c4203c_1_90;
	label$6c4203c_1_86:
	r7 = r2->bytes;
	r15 = 2;
	r15 = r13 << r15;
	...
	r14 = r14 + r15;
	r8 = r14;
	goto label$6c4203c_1_95;
	label$6c4203c_1_94:
	++r8;
	label$6c4203c_1_95:
	goto label$6c4203c_1_42;
	label$6c4203c_1_96:
	r12 = (kha__$KravurImage)g$_kha_KravurImage;
	r5 = r12->charBlocks;
	if( r5 == NULL ) hl_null_access();
	...
	r9 = r9 - r10;
	r10 = r2->length;
	if( ((unsigned)r9) < ((unsigned)r10) ) goto label$6c4203c_1_107;
	r9 = 0;
	goto label$6c4203c_1_111;
	label$6c4203c_1_107:
	r7 = r2->bytes;
	r10 = 2;
	r10 = r9 << r10;
	...
	if( r16 ) goto label$6c4203c_1_218;
	r9 = 64;
	r10 = 32;
	r13 = r2->length;
	...
	r15 = 0;
	if( r15 >= r13 ) goto label$6c4203c_1_144;
	...
	r15 = r18->length;
	if( ((unsigned)r14) < ((unsigned)r15) ) goto label$6c4203c_1_142;
	...
	r15 = r18->length;
	label$6c4203c_1_148:
	if( r14 >= r15 ) goto label$6c4203c_1_161;
	r24 = r14;
	++r14;
	...
	r24 = -1;
	if( r14 != r24 ) goto label$6c4203c_1_171;
	r28 = r0->blob;
	r15 = 0;
	...
	label$6c4203c_1_172:
	r25 = 0;
	if( r25 < r15 ) goto label$6c4203c_1_191;
	if( r10 >= r9 ) goto label$6c4203c_1_180;
	r25 = 2;
	r24 = r10 * r25;
	r10 = r24;
	goto label$6c4203c_1_183;
	label$6c4203c_1_180:
	r25 = 2;
	r24 = r9 * r25;
	r9 = r24;
...
void kha_Kravur_new(kha__Kravur r0,kha__internal__BytesBlob r1,int* r2) {
	haxe__ds__IntMap r4;
	int r3;
	if( r2 ) goto label$6c4203c_4_3;
	r3 = 0;
	goto label$6c4203c_4_4;
	label$6c4203c_4_3:
	r3 = *r2;
	label$6c4203c_4_4:
