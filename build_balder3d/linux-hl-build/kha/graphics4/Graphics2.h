...
#ifndef INC_kha__graphics4__Graphics2
#define INC_kha__graphics4__Graphics2
typedef struct _kha__graphics4__$Graphics2 *kha__graphics4__$Graphics2;
typedef struct _kha__graphics4__Graphics2 *kha__graphics4__Graphics2;
#include <hl/Class.h>
...
struct _kha__graphics4__$Graphics2 {
	hl_type *$type;
	hl_type* __type__;
	vdynamic* __meta__;
	...
	kha__graphics4__PipelineState videoPipeline;
	kha__graphics4__Graphics2 current;
	vclosure* upperPowerOfTwo;
	vclosure* createImageVertexStructure;
	vclosure* createImagePipeline;
	vclosure* createColoredVertexStructure;
	vclosure* createColoredPipeline;
	vclosure* createTextVertexStructure;
	vclosure* createTextPipeline;
};
struct _kha__graphics4__Graphics2 {
	hl_type *$type;
