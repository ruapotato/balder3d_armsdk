...
void kha_KravurImage_new(kha__KravurImage r0,int r1,int r2,int r3,int r4,int r5,int r6,hl__types__ArrayObj r7,kha__internal__BytesBlob r8) {
	...
	r20 = NULL;
	r21 = NULL;
	r18 = kha_Image_create(r5,r6,r19,r20,r21);
	r0->texture = r18;
	r18 = r0->texture;
	if( r18 == NULL ) hl_null_access();
	r23 = NULL;
	r22 = kha_Image_lock(r18,r23);
	r9 = 0;
	r12 = 0;
	r13 = r6;
	label$5871e49_1_39:
	if( r12 >= r13 ) goto label$5871e49_1_54;
	++r12;
	r24 = 0;
	r25 = r5;
	label$5871e49_1_44:
	if( r24 >= r25 ) goto label$5871e49_1_53;
	++r24;
	if( r22 == NULL ) hl_null_access();
	if( r8 == NULL ) hl_null_access();
	r26 = kha_internal_BytesBlob_readU8(r8,r9);
	haxe_io_Bytes_set(r22,r9,r26);
	++r9;
	goto label$5871e49_1_44;
	label$5871e49_1_53:
	goto label$5871e49_1_39;
	label$5871e49_1_54:
	r18 = r0->texture;
	if( r18 == NULL ) hl_null_access();
