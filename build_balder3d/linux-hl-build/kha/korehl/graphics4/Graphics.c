...
void kha_korehl_graphics4_Graphics_setVertexBuffer(kha__korehl__graphics4__Graphics r0,kha__graphics4__VertexBuffer r1) {
	...
	r3 = r1->_buffer;
	hl_kinc_graphics_set_vertexbuffer(r3);
	return;
}
...
void kha_korehl_graphics4_Graphics_setVertexBuffers(kha__korehl__graphics4__Graphics r0,hl__types__ArrayObj r1) {
	...
	label$cb1cbbc_5_61:
	r4 = r1->length;
	hl_kinc_graphics_set_vertexbuffers(r3,r9,r10,r11,r4);
	return;
}
...
void kha_korehl_graphics4_Graphics_setIndexBuffer(kha__korehl__graphics4__Graphics r0,kha__graphics4__IndexBuffer r1) {
	...
	if( r1 == NULL ) hl_null_access();
	r3 = r1->_buffer;
	hl_kinc_graphics_set_indexbuffer(r3);
	return;
}
...
void kha_korehl_graphics4_Graphics_setCubeMap(kha__korehl__graphics4__Graphics r0,vvirtual* r1,kha__graphics4__CubeMap r2) {
	...
	r4 = r5->_unit;
	r6 = r2->_texture;
	hl_kinc_graphics_set_cubemap_texture(r4,r6);
	...
	r4 = r5->_unit;
	r6 = r2->_renderTarget;
	hl_kinc_graphics_set_cubemap_target(r4,r6);
	label$cb1cbbc_7_16:
	return;
}
...
void kha_korehl_graphics4_Graphics_setTextureParameters(kha__korehl__graphics4__Graphics r0,vvirtual* r1,int r2,int r3,int r4,int r5,int r6) {
	...
	r8 = r9->_unit;
	hl_kinc_graphics_set_texture_parameters(r8,r2,r3,r4,r5,r6);
	return;
}
...
void kha_korehl_graphics4_Graphics_setTexture3DParameters(kha__korehl__graphics4__Graphics r0,vvirtual* r1,int r2,int r3,int r4,int r5,int r6,int r7) {
	...
	r9 = r10->_unit;
	hl_kinc_graphics_set_texture3d_parameters(r9,r2,r3,r4,r5,r6,r7);
	return;
}
...
void kha_korehl_graphics4_Graphics_setTextureCompareMode(kha__korehl__graphics4__Graphics r0,vvirtual* r1,bool r2) {
	...
	if( r5 == NULL ) hl_null_access();
	r4 = r5->_unit;
	hl_kinc_graphics_set_texture_compare_mode(r4,r2);
	return;
}
...
void kha_korehl_graphics4_Graphics_setCubeMapCompareMode(kha__korehl__graphics4__Graphics r0,vvirtual* r1,bool r2) {
	...
	if( r5 == NULL ) hl_null_access();
	r4 = r5->_unit;
	hl_kinc_graphics_set_cube_map_compare_mode(r4,r2);
	return;
}
...
void kha_korehl_graphics4_Graphics_setTexture(kha__korehl__graphics4__Graphics r0,vvirtual* r1,kha__Image r2) {
	kha__korehl__graphics4__TextureUnit r5;
	vbyte *r4, *r6;
	if( r2 ) goto label$cb1cbbc_15_2;
	return;
	label$cb1cbbc_15_2:
	if( r2 == NULL ) hl_null_access();
	r4 = r2->_texture;
	if( !r4 ) goto label$cb1cbbc_15_11;
	r5 = (kha__korehl__graphics4__TextureUnit)hl_dyn_castp(&r1,&t$vrt_b840ca7,&t$kha_korehl_graphics4_TextureUnit);
	if( r5 == NULL ) hl_null_access();
	r4 = r5->_unit;
	r6 = r2->_texture;
	hl_kinc_graphics_set_texture(r4,r6);
	goto label$cb1cbbc_15_16;
	label$cb1cbbc_15_11:
	r5 = (kha__korehl__graphics4__TextureUnit)hl_dyn_castp(&r1,&t$vrt_b840ca7,&t$kha_korehl_graphics4_TextureUnit);
	if( r5 == NULL ) hl_null_access();
	r4 = r5->_unit;
	r6 = r2->_renderTarget;
	hl_kinc_graphics_set_render_target(r4,r6);
	label$cb1cbbc_15_16:
	return;
}
...
void kha_korehl_graphics4_Graphics_setTextureDepth(kha__korehl__graphics4__Graphics r0,vvirtual* r1,kha__Image r2) {
	...
	if( r2 == NULL ) hl_null_access();
	r6 = r2->_renderTarget;
	hl_kinc_graphics_set_texture_depth(r4,r6);
	return;
}
...
void kha_korehl_graphics4_Graphics_setImageTexture(kha__korehl__graphics4__Graphics r0,vvirtual* r1,kha__Image r2) {
	...
	if( r2 == NULL ) hl_null_access();
	r6 = r2->_texture;
	hl_kinc_graphics_set_image_texture(r4,r6);
	return;
}
...
void kha_korehl_graphics4_Graphics_setBool(kha__korehl__graphics4__Graphics r0,vvirtual* r1,bool r2) {
	...
	if( r5 == NULL ) hl_null_access();
	r4 = r5->_location;
	hl_kinc_graphics_set_bool(r4,r2);
	return;
}
...
void kha_korehl_graphics4_Graphics_setInt(kha__korehl__graphics4__Graphics r0,vvirtual* r1,int r2) {
	...
	if( r5 == NULL ) hl_null_access();
	r4 = r5->_location;
	hl_kinc_graphics_set_int(r4,r2);
	return;
}
...
void kha_korehl_graphics4_Graphics_setFloat(kha__korehl__graphics4__Graphics r0,vvirtual* r1,float r2) {
	...
	if( r5 == NULL ) hl_null_access();
	r4 = r5->_location;
	hl_kinc_graphics_set_float(r4,r2);
	return;
}
...
void kha_korehl_graphics4_Graphics_setFloat2(kha__korehl__graphics4__Graphics r0,vvirtual* r1,float r2,float r3) {
	...
	if( r6 == NULL ) hl_null_access();
	r5 = r6->_location;
	hl_kinc_graphics_set_float2(r5,r2,r3);
	return;
}
...
void kha_korehl_graphics4_Graphics_setFloat3(kha__korehl__graphics4__Graphics r0,vvirtual* r1,float r2,float r3,float r4) {
	...
	r6 = r7->_location;
	hl_kinc_graphics_set_float3(r6,r2,r3,r4);
	return;
}
...
void kha_korehl_graphics4_Graphics_setFloat4(kha__korehl__graphics4__Graphics r0,vvirtual* r1,float r2,float r3,float r4,float r5) {
	...
	r7 = r8->_location;
	hl_kinc_graphics_set_float4(r7,r2,r3,r4,r5);
	return;
}

void kha_korehl_graphics4_Graphics_setFloats(kha__korehl__graphics4__Graphics r0,vvirtual* r1,kha__arrays__ByteArrayPrivate r2) {
	kha__korehl__graphics4__ConstantLocation r5;
	int r7, r8;
	vbyte *r4, *r6;
	r5 = (kha__korehl__graphics4__ConstantLocation)hl_dyn_castp(&r1,&t$vrt_b840ca7,&t$kha_korehl_graphics4_ConstantLocation);
	...
	if( r2 == NULL ) hl_null_access();
	r6 = r2->self;
	r7 = r2->byteArrayLength;
	r8 = 2;
	r7 = r7 >> r8;
	hl_kinc_graphics_set_floats(r4,r6,r7);
	return;
}
...
void kha_korehl_graphics4_Graphics_setMatrix(kha__korehl__graphics4__Graphics r0,vvirtual* r1,kha__math__FastMatrix4 r2) {
	...
	r20 = r2->_23;
	r21 = r2->_33;
	hl_kinc_graphics_set_matrix(r4,r6,r7,r8,r9,r10,r11,r12,r13,r14,r15,r16,r17,r18,r19,r20,r21);
	return;
}
...
void kha_korehl_graphics4_Graphics_setMatrix3(kha__korehl__graphics4__Graphics r0,vvirtual* r1,kha__math__FastMatrix3 r2) {
	...
	r13 = r2->_12;
	r14 = r2->_22;
	hl_kinc_graphics_set_matrix3(r4,r6,r7,r8,r9,r10,r11,r12,r13,r14);
	return;
}

void kha_korehl_graphics4_Graphics_drawIndexedVertices(kha__korehl__graphics4__Graphics r0,int* r1,int* r2) {
	int r3, r4, r6;
	if( r1 ) goto label$cb1cbbc_28_3;
	r3 = 0;
	goto label$cb1cbbc_28_4;
	label$cb1cbbc_28_3:
	r3 = *r1;
	label$cb1cbbc_28_4:
	if( r2 ) goto label$cb1cbbc_28_7;
	r4 = -1;
	goto label$cb1cbbc_28_8;
	label$cb1cbbc_28_7:
	r4 = *r2;
	label$cb1cbbc_28_8:
	r6 = 0;
	if( r4 >= r6 ) goto label$cb1cbbc_28_12;
	hl_kinc_graphics_draw_all_indexed_vertices();
	goto label$cb1cbbc_28_13;
	label$cb1cbbc_28_12:
	hl_kinc_graphics_draw_indexed_vertices(r3,r4);
	label$cb1cbbc_28_13:
	return;
}
...
void kha_korehl_graphics4_Graphics_drawIndexedVerticesInstanced(kha__korehl__graphics4__Graphics r0,int r1,int* r2,int* r3) {
	int r4, r5, r7;
	if( r2 ) goto label$cb1cbbc_29_3;
	r4 = 0;
	goto label$cb1cbbc_29_4;
	label$cb1cbbc_29_3:
	r4 = *r2;
	label$cb1cbbc_29_4:
	if( r3 ) goto label$cb1cbbc_29_7;
	r5 = -1;
	goto label$cb1cbbc_29_8;
	label$cb1cbbc_29_7:
	r5 = *r3;
	label$cb1cbbc_29_8:
	r7 = 0;
	if( r5 >= r7 ) goto label$cb1cbbc_29_12;
	hl_kinc_graphics_draw_all_indexed_vertices_instanced(r1);
	goto label$cb1cbbc_29_13;
	label$cb1cbbc_29_12:
	hl_kinc_graphics_draw_indexed_vertices_instanced(r1,r4,r5);
	label$cb1cbbc_29_13:
	return;
}
...
void kha_korehl_graphics4_Graphics_renderToTexture(kha__korehl__graphics4__Graphics r0,hl__types__ArrayObj r1) {
	...
	int r3, r8, r9;
	if( !r1 ) goto label$cb1cbbc_30_116;
	if( r1 == NULL ) hl_null_access();
	r3 = r1->length;
	r5 = r0->target;
	r6 = (kha__Image)hl_dyn_castp(&r5,&t$vrt_7ced7cf,&t$kha_Image);
	if( r6 == NULL ) hl_null_access();
	r4 = r6->_renderTarget;
	r9 = 0;
	if( r9 >= r3 ) goto label$cb1cbbc_30_21;
	r8 = 0;
	r9 = r1->length;
	if( ((unsigned)r8) < ((unsigned)r9) ) goto label$cb1cbbc_30_14;
	r5 = NULL;
	goto label$cb1cbbc_30_17;
	label$cb1cbbc_30_14:
	r11 = r1->array;
	r10 = ((vdynamic**)(r11 + 1))[r8];
	r5 = hl_to_virtual(&t$vrt_7ced7cf,(vdynamic*)r10);
	label$cb1cbbc_30_17:
	r6 = (kha__Image)hl_dyn_castp(&r5,&t$vrt_7ced7cf,&t$kha_Image);
	if( r6 == NULL ) hl_null_access();
	r7 = r6->_renderTarget;
	goto label$cb1cbbc_30_22;
	label$cb1cbbc_30_21:
	r7 = NULL;
	label$cb1cbbc_30_22:
	r9 = 1;
	if( r9 >= r3 ) goto label$cb1cbbc_30_36;
	r8 = 1;
	r9 = r1->length;
	if( ((unsigned)r8) < ((unsigned)r9) ) goto label$cb1cbbc_30_29;
	r5 = NULL;
	goto label$cb1cbbc_30_32;
	label$cb1cbbc_30_29:
	r11 = r1->array;
	r10 = ((vdynamic**)(r11 + 1))[r8];
	r5 = hl_to_virtual(&t$vrt_7ced7cf,(vdynamic*)r10);
	...
	goto label$cb1cbbc_30_37;
	label$cb1cbbc_30_36:
	r12 = NULL;
	label$cb1cbbc_30_37:
	r9 = 2;
	if( r9 >= r3 ) goto label$cb1cbbc_30_51;
	r8 = 2;
	r9 = r1->length;
	if( ((unsigned)r8) < ((unsigned)r9) ) goto label$cb1cbbc_30_44;
	r5 = NULL;
	goto label$cb1cbbc_30_47;
	label$cb1cbbc_30_44:
	r11 = r1->array;
	r10 = ((vdynamic**)(r11 + 1))[r8];
	r5 = hl_to_virtual(&t$vrt_7ced7cf,(vdynamic*)r10);
	...
	goto label$cb1cbbc_30_52;
	label$cb1cbbc_30_51:
	r13 = NULL;
	label$cb1cbbc_30_52:
	r9 = 3;
	if( r9 >= r3 ) goto label$cb1cbbc_30_66;
	r8 = 3;
	r9 = r1->length;
	if( ((unsigned)r8) < ((unsigned)r9) ) goto label$cb1cbbc_30_59;
	r5 = NULL;
	goto label$cb1cbbc_30_62;
	label$cb1cbbc_30_59:
	r11 = r1->array;
	r10 = ((vdynamic**)(r11 + 1))[r8];
	r5 = hl_to_virtual(&t$vrt_7ced7cf,(vdynamic*)r10);
	...
	goto label$cb1cbbc_30_67;
	label$cb1cbbc_30_66:
	r14 = NULL;
	label$cb1cbbc_30_67:
	r9 = 4;
	if( r9 >= r3 ) goto label$cb1cbbc_30_81;
	r8 = 4;
	r9 = r1->length;
	if( ((unsigned)r8) < ((unsigned)r9) ) goto label$cb1cbbc_30_74;
	r5 = NULL;
	goto label$cb1cbbc_30_77;
	label$cb1cbbc_30_74:
	r11 = r1->array;
	r10 = ((vdynamic**)(r11 + 1))[r8];
	r5 = hl_to_virtual(&t$vrt_7ced7cf,(vdynamic*)r10);
	...
	goto label$cb1cbbc_30_82;
	label$cb1cbbc_30_81:
	r15 = NULL;
	label$cb1cbbc_30_82:
	r9 = 5;
	if( r9 >= r3 ) goto label$cb1cbbc_30_96;
	r8 = 5;
	r9 = r1->length;
	if( ((unsigned)r8) < ((unsigned)r9) ) goto label$cb1cbbc_30_89;
	r5 = NULL;
	goto label$cb1cbbc_30_92;
	label$cb1cbbc_30_89:
	r11 = r1->array;
	r10 = ((vdynamic**)(r11 + 1))[r8];
	r5 = hl_to_virtual(&t$vrt_7ced7cf,(vdynamic*)r10);
	...
	goto label$cb1cbbc_30_97;
	label$cb1cbbc_30_96:
	r16 = NULL;
	label$cb1cbbc_30_97:
	r9 = 6;
	if( r9 >= r3 ) goto label$cb1cbbc_30_111;
	r8 = 6;
	r9 = r1->length;
	if( ((unsigned)r8) < ((unsigned)r9) ) goto label$cb1cbbc_30_104;
	r5 = NULL;
	goto label$cb1cbbc_30_107;
	label$cb1cbbc_30_104:
	r11 = r1->array;
	r10 = ((vdynamic**)(r11 + 1))[r8];
	r5 = hl_to_virtual(&t$vrt_7ced7cf,(vdynamic*)r10);
	label$cb1cbbc_30_107:
	r6 = (kha__Image)hl_dyn_castp(&r5,&t$vrt_7ced7cf,&t$kha_Image);
	if( r6 == NULL ) hl_null_access();
	r17 = r6->_renderTarget;
	goto label$cb1cbbc_30_112;
	label$cb1cbbc_30_111:
	r17 = NULL;
	label$cb1cbbc_30_112:
	r9 = 1;
	r8 = r3 + r9;
	hl_kinc_graphics_render_to_textures(r4,r7,r12,r13,r14,r15,r16,r17,r8);
	goto label$cb1cbbc_30_121;
	label$cb1cbbc_30_116:
	r5 = r0->target;
	r6 = (kha__Image)hl_dyn_castp(&r5,&t$vrt_7ced7cf,&t$kha_Image);
	if( r6 == NULL ) hl_null_access();
	r4 = r6->_renderTarget;
	hl_kinc_graphics_render_to_texture(r4);
	label$cb1cbbc_30_121:
	return;
}
...
void kha_korehl_graphics4_Graphics_begin(kha__korehl__graphics4__Graphics r0,hl__types__ArrayObj r1) {
	vvirtual *r3;
	r3 = r0->target;
	if( r3 ) goto label$cb1cbbc_31_4;
	hl_kinc_graphics_restore_render_target();
	goto label$cb1cbbc_31_5;
	label$cb1cbbc_31_4:
...
void kha_korehl_graphics4_Graphics_beginFace(kha__korehl__graphics4__Graphics r0,int r1) {
	...
	vbyte *r3;
	r4 = r0->target;
	r5 = (kha__graphics4__CubeMap)hl_dyn_castp(&r4,&t$vrt_7ced7cf,&t$kha_graphics4_CubeMap);
	if( r5 == NULL ) hl_null_access();
	r3 = r5->_renderTarget;
	hl_kinc_graphics_render_to_face(r3,r1);
	return;
}
