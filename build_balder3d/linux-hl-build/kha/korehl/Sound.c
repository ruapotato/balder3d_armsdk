...
void kha_korehl_Sound_initWav(kha__korehl__Sound r0,String r1) {
	int64 r17;
	kha__arrays__ByteArrayPrivate r2, r14;
	double r6, r15;
	double *r7;
	int *r5, *r10;
	vbyte *r9, *r11, *r13;
	int r3, r8, r12, r16, r18;
	r3 = 1;
	r2 = kha_arrays__Uint32Array_Uint32Array_Impl___new(r3);
	r3 = r0->sampleRate;
	r5 = &r3;
	r6 = r0->length;
	r7 = &r6;
	...
	r13 = r2->self;
	r11 = hl_kinc_sound_init_wav(r11,r13,r5,r7);
	r12 = *r5;
	r0->sampleRate = r12;
	r15 = *r7;
	r0->length = r15;
	r14 = (kha__arrays__ByteArrayPrivate)hl_alloc_obj(&t$kha_arrays_ByteArrayPrivate);
	r12 = 0;
	r13 = r2->self;
	r16 = r2->byteArrayOffset;
	r17 = hl_kinc_bytearray_getuint32(r13,r16);
	r16 = (int)r17;
	r18 = 4;
	r16 = r16 * r18;
	kha_arrays_ByteArrayPrivate_new(r14,r12,r16);
	r14->self = r11;
	r0->uncompressedData = r14;
	r13 = r2->self;
	kha_arrays__ByteBuffer_ByteBuffer_Impl__free(r13);
	return;
}
